...
class UsersModelDataData {
  ...
  factory UsersModelDataData.loadDataJson() {
    return UsersModelDataFromJson(usersDataJson);
  }

  static UsersModelDataData UsersModelDataFromJson(String str) =>
      UsersModelDataData.fromJson(json.decode(str));
  // end

  factory UsersModelDataData.fromRawJson(String str) =>
      UsersModelDataData.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory UsersModelDataData.fromJson(Map<String, dynamic> json) => UsersModelDataData(
...
class UsersData {
  ...
  factory UsersData.blankDefaultValues() {
    return UsersData(
      gender: Gender.male,
